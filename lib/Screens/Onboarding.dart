            ...
            child: Column(
              children: [
                ...
                const Padding(
                    ...
                    child: Text(
                      'Speaksy is a platform designed to help event organizers and individuals to find speakers based off languages and specialized topics. The app provides detailed profiles to view, as well as any relevant information needed when picking your desired speaker.',
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context)
                            .push(slidingFromLeft(LoginScreen()));
                      },
                      child: const Text(
                        'GET STARTED',
                        style: TextStyle(
